...
<div class="relative">
    <div class="">
        <div class="w-full bg-no-repeat bg-cover h-96 lg:h-screen" style="z-index: -1; background-image: url('assets/images/bg.jpg');" x-show="!image">
            <div class="lg:py-24 lg:pl-14">
                <h1 class="mt-4 text-4xl font-extrabold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    <span class="block">L'incroyable</span>
                    <span class="block pb-3 text-transparent bg-clip-text bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">OCR Sudoku</span>
                </h1>
                <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                Léo Capmartin, Thomas Corbiere, Thomas Didier, Hugo Saint-germes et Olivier Talane
                </p>
            </div>
        </div>
